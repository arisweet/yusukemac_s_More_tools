...
public class ToolHelper {
    ...
    public static void addToolsRecipe(Item Axe, Item Pickaxe, Item Shovel, Item Hoe, Item Sword, Object material, Object stick)
    {
    	...
    	addRecipe(Sword, 1, createSwordObject(material, stick));
    }
    public static void addToolsRecipe(Item Axe, Item Pickaxe, Item Shovel, Item Hoe, Object material, Object stick)
    {
    	addRecipe(Axe, 1, createAxeObject(material, stick));
    	addRecipe(Pickaxe, 1, createPickaxeObject(material, stick));
    	addRecipe(Shovel, 1, createShovelObject(material, stick));
    	addRecipe(Hoe, 1, createHoeObject(material, stick));
