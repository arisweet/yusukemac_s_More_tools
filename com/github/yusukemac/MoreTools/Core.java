...
public class Core {
	...
	private Property hiddennameProp, hammerProp, snowplowProp, superdiggerProp, toolofnatureProp, tooloftheearthProp, stonebreakerProp, plasticProp, tooloftheearthdebrisProp;
	...
	/** 単体アイテムのIDを入れておく */
	public int SuperDiggerID, ToolOfNatureID, ToolOfTheEarthID, PlasticID, StoneBreakerID, ToolOfTheEarthDebrisID;
	/** 新しいツール用マテリアル*/
	...
	private void setTranslatedName()
	{
		...
		LanguageRegistry.instance().addStringLocalization(timeToSnowRemoval.getName(), "en_US", "Time to Snow removal!");
		LanguageRegistry.instance().addStringLocalization(timeToSnowRemoval.getName(), "ja_JP", "いざ除雪!");
		LanguageRegistry.instance().addStringLocalization(timeToSnowRemoval.getName() + ".desc", "en_US", "craft any Snowplow");
		LanguageRegistry.instance().addStringLocalization(timeToSnowRemoval.getName() + ".desc", "ja_JP", "除雪機を作る");
        
		LanguageRegistry.instance().addStringLocalization(timeToDismantling.getName(), "en_US", "Time to Dismantling!");
		LanguageRegistry.instance().addStringLocalization(timeToDismantling.getName(), "ja_JP", "いざ解体!");
		LanguageRegistry.instance().addStringLocalization(timeToDismantling.getName() + ".desc", "en_US", "craft any Hammer");
		LanguageRegistry.instance().addStringLocalization(timeToDismantling.getName() + ".desc", "ja_JP", "ハンマーを作る");
        
		LanguageRegistry.instance().addStringLocalization(getPlasticIngot.getName(), "en_US", "Get plastic ingot!");
		LanguageRegistry.instance().addStringLocalization(getPlasticIngot.getName(), "ja_JP", "プラスチックインゴットを手に入れる");
		LanguageRegistry.instance().addStringLocalization(getPlasticIngot.getName() + ".desc", "en_US", "smelting Plastic ore, and get ingots");
		LanguageRegistry.instance().addStringLocalization(getPlasticIngot.getName() + ".desc", "ja_JP", "プラスチック鉱石を精錬し、インゴットを取得しよう");
        
		LanguageRegistry.instance().addStringLocalization(craftToolOfTheEarth.getName(), "en_US", "§eMILLIONAIRE§r");
		LanguageRegistry.instance().addStringLocalization(craftToolOfTheEarth.getName(), "ja_JP", "§e大富豪§r");
		LanguageRegistry.instance().addStringLocalization(craftToolOfTheEarth.getName() + ".desc", "en_US", "craft §bTool of The Earth§r.");
		LanguageRegistry.instance().addStringLocalization(craftToolOfTheEarth.getName() + ".desc", "ja_JP", "§b地球のツール§rを作る");
